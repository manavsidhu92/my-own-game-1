var woodcutter, wcpic, tree1, t1, tree2, t2, tree3, t3, tree4, t4, tree5, t5;
var treescount, timer, Sharpness;

function preload(){
t1= loadImage("tree1.png")
t2= loadImage("tree2.png")
t3= loadImage("tree3.jpg")
...
textSize(25)
fill("yellow")
text("Congrats you have won the Mission, and Lost Your Life", 300, 500)
woodcutter.destroy();
}
function gameover(){
    textSize(40)
